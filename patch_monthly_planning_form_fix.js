...
const regex = /<form onSubmit=\{handleAddPlanned\} className="flex gap-2 mb-2">[\s\S]*?<\/button>\s*<\/form>/;

const replacement = `<form onSubmit={handleAddPlanned} className="flex flex-col gap-2 mb-2">
